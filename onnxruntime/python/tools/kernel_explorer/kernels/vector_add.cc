...
class VectorAdd : public Operator<T> {
 public:
  VectorAdd(DeviceArray& x, DeviceArray& y, DeviceArray& z, int n) : x_(reinterpret_cast<T*>(x.ptr())),
...
class VectorAddTunable : public Operator<T> {
 public:
  VectorAddTunable(DeviceArray& x, DeviceArray& y, DeviceArray& z, int n) : x_(reinterpret_cast<T*>(x.ptr())),
                                                                            y_(reinterpret_cast<T*>(y.ptr())),
                                                                            z_(reinterpret_cast<T*>(z.ptr())),
                                                                            n_(n),
                                                                            Operator<T>() {}
